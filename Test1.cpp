...
{
  cout << endl
       << "(1) ***** Test constructeur par defaut + Affiche *******************************" << endl;
  {
    Event event;
    event.display();
  ...
  cout << endl
       << "(2) ***** Test des setters et getters *****" << endl;
  {
    Event event;
    event.setCode(1);
  ...
  cout << endl
       << "(3) ***** Test du constructeur d'initialisation ********************************" << endl;
  {
  ...
  cout << endl
       << "(4) ***** Test du constructeur de copie ****************************************" << endl;
  {
  ...
  cout << endl
       << "(5) ***** Test d'allocation dynamique (constructeur par defaut) ****************" << endl;
  {
    Event *p = new Event();
    p->setCode(3);
  ...
  cout << endl
       << "(6) ***** Test d'allocation dynamique (constructeur de copie) ******************" << endl;
  {
